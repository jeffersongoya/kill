...
procedure TForm1.ApagarArqLogs;
...
function TForm1.IfThen(AValue: Boolean; const ATrue: string;
      AFalse: string): string;
begin
  if AValue then
    Result := ATrue
...
procedure TForm1.ApagarArqTemps;
...
procedure TForm1.ApagarCfgCache;
...
procedure TForm1.ApagarTemporarios;
...
procedure TForm1.Homologadores;
var Rec: TSearchRec; i,p: integer; lista: TStringList;
...
procedure TForm1.ApagarCertificados;
var Rec: TSearchRec; i: integer; lista: TStringList;
begin
   Lista := TStringList.Create;
...
Function TForm1.ExtractSystemDir : String;
var Buffer : Array[0..144] of Char;
begin
